...
const Bio = ({mode}) => {
    return (
        <Box>
            ...
            <Typography variant='subtitle1' sx={{ maxWidth: 700, mx: 'auto', textAlign: 'center', mt: 2, color: mode ? 'green2019d' : 'blue2022d'  }}>
                <span className="title" sx={{ lineHeight: 1.2}} style={{  }}>
