...
return (
    blogData.map((item) => (
        ...
        <List>
            ...
            <ListItem>
            <Typography className='blog' variant='h4' fontWeight='semibold' mt={1} sx={{maxWidth: 700, mx: 'auto', color: mode ? 'green2019d' : 'blue2022d'}}>
                <span className="title" >
                    {item.titulo}
                    <Divider component="li" sx={{width: '90%', marginTop: '-4px',borderColor: mode ? 'green2019d' : 'blue2022d' , borderWidth: '1px', filter: 'blur(2px)'}} />
                </span>
