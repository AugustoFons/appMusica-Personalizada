...
const Redes = () => {
    return (
        <Box sx={{ maxWidth: 1000, mt: 1, mx: 'auto'}}>
                    <Box style={{ }}>
                        <Typography variant='h6' sx={{display: 'flex', justifyContent: 'center', textAlign: 'center', color: 'green2019d', my: 3}}>
                    ...
                    <Box class="redes">
                            ...
                            <span title="YouTube">
                                <YouTubeIcon fontSize="large" sx={{ color: 'green2019d', transform: 'scale(2.9)',ml:1.2, xs: {ml:0}, '&:hover': {color: '#9AA69C', cursor: 'pointer', transition: 'color 1s ease, background-color 0.3s ease'}}}/>
                            </span>
                    </Box>
